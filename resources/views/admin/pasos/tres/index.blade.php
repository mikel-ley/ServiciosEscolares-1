...
<a href="{{route('admin.alumnos.index')}}" class="btn btn-outline-success btn-sm float-right"><i class="fa fa-check"></i></a>
    ...
    <a href="#" class="float-right" data-toggle="modal" data-target="#ModalCreate"><img style="width: 50px" src="{{ asset('favicons/emails.svg') }}"></a>



    @include('admin.pasos.tres.modal.create')
@stop
