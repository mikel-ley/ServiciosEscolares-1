...
//Route::middleware(['auth:sanctum', 'verified'])->get('tres',[PasoTresController::class, 'index'])->name('admin.pasos.tres');
...
Route::group(['prefix'=>'paso'], function(){
    ...
    //Route::middleware(['auth:sanctum', 'verified'])->get('tres',[App\Http\Controllers\admin\PasoTresController::class, 'index'])->name('admin.pasos.tres');
    ...
    Route::resource('tres', App\Http\Controllers\admin\PasoTresController::class)->middleware('auth:sanctum','verified') ->names('admin.pasos.tres');
